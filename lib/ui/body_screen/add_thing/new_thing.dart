                          ...
                          onTap: () {
                            if (loadedCategories[index]['title'] !=
                              ...
                              for (var item
                                ...
                                String key = '${item['color']}_${item['name']}';
                      ...
                      ? Column(
                          children: [
                            Padding(
                              ...
                              child:
                                  Text('Subcategory', style: theme?.bodyMedium),
                            ),
                            Text(
                              'location',
              ...
              if (selectedCategoryIndex != -1 &&
                ...
                if (_image != null) {
                  await CategoryStorage.addImageToSubcategory(
                    ...
                    _image!.path, // Путь к изображению
                  );
                } else {
                  await CategoryStorage.addImageToSubcategory(
                    tmpSelectCategory['title'], // Название категории
  ...
  Widget newSubCategoryBlock({TextTheme? theme}) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 130.h, child: colorBlock(theme: theme)),
      ],
    );
  }
